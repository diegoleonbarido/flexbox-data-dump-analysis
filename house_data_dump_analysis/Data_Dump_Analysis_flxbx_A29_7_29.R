...
ambient <- read.csv('flxbxA29.7.29.2015.sqld_ambient_table.csv')
inside <- read.csv('flxbxA29.7.29.2015.sqld_inside_table.csv')
refrigerator <- read.csv('flxbxA29.7.29.2015.sqld_mfi_table.csv')
switch <- read.csv('flxbxA29.7.29.2015.sqld_switch_table.csv')
house <- read.csv('flxbxA29.7.29.2015.sqld_zwave_table.csv')
...
plot(refrigerator$time_stamp,refrigerator$power,xlab='Day',ylab='Fridge (W)',cex=0.2,pch=19,ylim=c(450,800))
