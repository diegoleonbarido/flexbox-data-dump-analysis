...
ambient <- read.csv('flxbxA11.7.29.2015.sqld_ambient_table.csv')
inside <- read.csv('flxbxA11.7.29.2015.sqld_inside_table.csv')
refrigerator <- read.csv('flxbxA11.7.29.2015.sqld_mfi_table.csv')
switch <- read.csv('flxbxA11.7.29.2015.sqld_switch_table.csv')
house <- read.csv('flxbxA11.7.29.2015.sqld_zwave_table.csv')
...
plot(inside$time_stamp,inside$temp1, xlab='Day',ylab='Inside T1 (C)',cex=0.1)
par(new=TRUE)
plot(inside$time_stamp,inside$temp2, xlab='Day',ylab='Inside T2 (C)',cex=0.1, col='red')

plot(refrigerator$time_stamp,refrigerator$power,xlab='Day',ylab='Fridge (W)',cex=0.2,pch=19,ylim=c(0,200))
...
day_ambient <- subset(ambient,ambient$date == '2015-07-27')
day_inside <- subset(inside, inside$date == '2015-07-27')
day_refrigerator <- subset(refrigerator, refrigerator$date == '2015-07-27')
day_switch <- subset(switch, switch$date == '2015-07-27')
day_house <- subset(house, house$date == '2015-07-27')
...
plot(day_inside$time_stamp, day_inside$temp1, xlab='Day',ylab='Inside T1 (C)',cex=0.1,ylim=c(0,20))
par(new=TRUE)
plot(day_inside$time_stamp, day_inside$temp2, xlab='Day',ylab='Inside T2 (C)',cex=0.1, col='red',ylim=c(0,20))
