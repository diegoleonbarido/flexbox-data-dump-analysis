...
ambient <- read.csv('flxbxA15.7.30.2015.sqld_ambient_table.csv')
inside <- read.csv('flxbxA15.7.30.2015.sqld_inside_table.csv')
refrigerator <- read.csv('flxbxA15.7.30.2015.sqld_mfi_table.csv')
switch <- read.csv('flxbxA15.7.30.2015.sqld_switch_table.csv')
house <- read.csv('flxbxA15.7.30.2015.sqld_zwave_table.csv')
...
day_ambient <- subset(ambient,ambient$date == '2015-07-20')
day_inside <- subset(inside, inside$date == '2015-07-20')
day_refrigerator <- subset(refrigerator, refrigerator$date == '2015-07-20')
day_switch <- subset(switch, switch$date == '2015-07-20')
day_house <- subset(house, house$date == '2015-07-20')
