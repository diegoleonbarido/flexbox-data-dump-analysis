...
ambient <- read.csv('flxbxA7.7.29.2015.sqld_ambient_table.csv')
inside <- read.csv('flxbxA7.7.29.2015.sqld_inside_table.csv')
refrigerator <- read.csv('flxbxA7.7.29.2015.sqld_mfi_table.csv')
switch <- read.csv('flxbxA7.7.29.2015.sqld_switch_table.csv')
house <- read.csv('flxbxA7.7.29.2015.sqld_zwave_table.csv')
...
plot(refrigerator$time_stamp,refrigerator$power,xlab='Day',ylab='Fridge (W)',cex=0.2,pch=19,ylim=c(200,400))
...
plot(day_inside$time_stamp, day_inside$temp1, xlab='Day',ylab='Inside T1 (C)',cex=0.1,ylim=c(-20,20))
par(new=TRUE)
plot(day_inside$time_stamp, day_inside$temp2, xlab='Day',ylab='Inside T2 (C)',cex=0.1, col='red',ylim=c(-20,20))
