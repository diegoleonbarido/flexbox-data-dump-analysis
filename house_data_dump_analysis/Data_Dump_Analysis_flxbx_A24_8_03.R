...
ambient <- read.csv('flxbxA24.8.03.2015.sqld_ambient_table.csv')
inside <- read.csv('flxbxA24.8.03.2015.sqld_inside_table.csv')
refrigerator <- read.csv('flxbxA24.8.03.2015.sqld_mfi_table.csv')
switch <- read.csv('flxbxA24.8.03.2015.sqld_switch_table.csv')
house <- read.csv('flxbxA24.8.03.2015.sqld_zwave_table.csv')
