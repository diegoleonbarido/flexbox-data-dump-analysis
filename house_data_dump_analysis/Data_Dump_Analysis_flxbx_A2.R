...
#Using the previous date because this one doesn't have a date
...
########### Ploting a one day subset - PLOT THE PREVIOUS DAY ON THE FILE - 
...
plot(day_inside$time_stamp, day_inside$temp1, xlab='Day',ylab='Inside T1 (C)',cex=0.1, ylim=c(-10,30))
par(new=TRUE)
plot(day_inside$time_stamp, day_inside$temp2, xlab='Day',ylab='Inside T2 (C)',cex=0.1,ylim=c(-10,30), col='red')

plot(day_refrigerator$time_stamp, day_refrigerator$power,ylim=c(0,1000),xlab='Day',ylab='Fridge (W)',cex=0.2,pch=19)
