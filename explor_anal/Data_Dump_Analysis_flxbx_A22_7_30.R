...
ambient <- read.csv('flxbxA22.7.30.2015.sqld_ambient_table.csv')
inside <- read.csv('flxbxA22.7.30.2015.sqld_inside_table.csv')
refrigerator <- read.csv('flxbxA22.7.30.2015.sqld_mfi_table.csv')
switch <- read.csv('flxbxA22.7.30.2015.sqld_switch_table.csv')
house <- read.csv('flxbxA22.7.30.2015.sqld_zwave_table.csv')
...
plot(inside$time_stamp,inside$temp1, xlab='Day',ylab='Inside T1 (C)',cex=0.1,ylim=c(0,35))

plot(refrigerator$time_stamp,refrigerator$power,xlab='Day',ylab='Fridge (W)',cex=0.2,pch=19,ylim=c(0,225))
...
plot(day_inside$time_stamp, day_inside$temp1, xlab='Day',ylab='Inside T1 (C)',cex=0.1,ylim=c(0,15))
