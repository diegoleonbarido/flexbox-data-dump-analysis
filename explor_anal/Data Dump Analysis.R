...
day_ambient <- subset(ambient,ambient$date == '2015-07-17')
day_inside <- subset(inside, inside$date == '2015-07-17')
day_refrigerator <- subset(refrigerator, refrigerator$date == '2015-07-17')
day_switch <- subset(switch, switch$date == '2015-07-17')
day_house <- subset(house, house$date == '2015-07-17')
