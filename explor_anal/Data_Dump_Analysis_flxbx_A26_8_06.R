...
ambient <- read.csv('flxbxA26.8.06.2015.sqld_ambient_table.csv')
inside <- read.csv('flxbxA26.8.06.2015.sqld_inside_table.csv')
refrigerator <- read.csv('flxbxA26.8.06.2015.sqld_mfi_table.csv')
switch <- read.csv('flxbxA26.8.06.2015.sqld_switch_table.csv')
house <- read.csv('flxbxA26.8.06.2015.sqld_zwave_table.csv')
...
plot(inside$time_stamp,inside$temp1, xlab='Day',ylab='Inside T1 (C)',cex=0.1,ylim=c(-5,25))
par(new=TRUE)
plot(inside$time_stamp,inside$temp2, xlab='Day',ylab='Inside T2 (C)',cex=0.1, col='red',ylim=c(-5,25))

plot(refrigerator$time_stamp,refrigerator$power,xlab='Day',ylab='Fridge (W)',cex=0.2,pch=19)
...
plot(inside$time_stamp,inside$temp1, xlab='Day',ylab='Inside T1 (C)',cex=0.1,ylim=c(-5,15))
par(new=TRUE)
plot(inside$time_stamp,inside$temp2, xlab='Day',ylab='Inside T2 (C)',cex=0.1, col='red',ylim=c(-5,15))
...
day_ambient <- subset(ambient,ambient$date == '2015-07-26')
day_inside <- subset(inside, inside$date == '2015-07-26')
day_refrigerator <- subset(refrigerator, refrigerator$date == '2015-07-26')
day_switch <- subset(switch, switch$date == '2015-07-26')
day_house <- subset(house, house$date == '2015-07-26')
...
plot(day_inside$time_stamp, day_inside$temp1, xlab='Day',ylab='Inside T1 (C)',cex=0.1,ylim=c(-10,50))
par(new=TRUE)
plot(day_inside$time_stamp, day_inside$temp2, xlab='Day',ylab='Inside T2 (C)',cex=0.1, col='red',ylim=c(-10,50))
