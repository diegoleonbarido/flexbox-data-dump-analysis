...
plot(day_inside$time_stamp, day_inside$temp1, xlab='Day',ylab='Inside T1 (C)',cex=0.1,ylim=c(-20,30))
par(new=TRUE)
plot(day_inside$time_stamp, day_inside$temp2, xlab='Day',ylab='Inside T2 (C)',cex=0.1, col='red',ylim=c(-20,30))
