...
ambient <- read.csv('flxbxA14.7.30.sqld_ambient_table.csv')
inside <- read.csv('flxbxA14.7.30.sqld_inside_table.csv')
refrigerator <- read.csv('flxbxA14.7.30.sqld_mfi_table.csv')
switch <- read.csv('flxbxA14.7.30.sqld_switch_table.csv')
house <- read.csv('flxbxA14.7.30.sqld_zwave_table.csv')
