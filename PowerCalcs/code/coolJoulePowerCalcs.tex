...
\hlstd{plot1} \hlkwb{<-} \hlkwd{ggplot}\hlstd{(}\hlkwc{data} \hlstd{= pwr1,} \hlkwd{aes}\hlstd{(sampleSize, Power))} \hlopt{+}
          \hlkwd{geom_smooth}\hlstd{(}\hlkwc{fill} \hlstd{=} \hlnum{NA}\hlstd{)} \hlopt{+} \hlkwd{geom_point}\hlstd{()} \hlopt{+} \hlkwd{geom_hline}\hlstd{(}\hlkwc{yintercept}\hlstd{=}\hlnum{.8}\hlstd{)} \hlopt{+}
...
\section{Power Calculations 3}
Fix Flexbox at $N = 100$ and then make control group larger
\begin{knitrout}
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlcom{###################################}
\hlcom{# SECTION 3 - POWER CALCS SIM 3}
\hlcom{###################################}
...
\hlstd{nFinder} \hlkwb{<-} \hlkwa{function}\hlstd{(}\hlkwc{N}\hlstd{,} \hlkwc{cluster}\hlstd{,} \hlkwc{logs}\hlstd{,} \hlkwc{levels}\hlstd{)\{}
  ...
  \hlcom{# sample N observations with replacement}
  \hlstd{bootSampleControl}   \hlkwb{<-} \hlkwd{sample_n}\hlstd{(controlHHs,} \hlkwc{size} \hlstd{= N,} \hlkwc{replace} \hlstd{=} \hlnum{TRUE}\hlstd{)}
  \hlstd{bootSampleTreatment} \hlkwb{<-} \hlkwd{sample_n}\hlstd{(treatmentHHs,} \hlkwc{size} \hlstd{=} \hlnum{100}\hlstd{,} \hlkwc{replace} \hlstd{=} \hlnum{TRUE}\hlstd{)}
  \hlstd{bootSample} \hlkwb{<-} \hlkwd{rbind}\hlstd{(bootSampleControl,bootSampleTreatment)}
  \hlstd{bootSample} \hlkwb{<-} \hlstd{bootSample} \hlopt{%>%} \hlkwd{mutate}\hlstd{(}\hlkwc{bootID} \hlstd{=} \hlkwd{row_number}\hlstd{())}
  ...
  \hlstd{\}}
  \hlcom{# boolean to check if p-value of treatment effect coef. est. is <0.05}
  \hlcom{#print(tidy(nReg)$p.value < .05)}
  \hlkwd{tidy}\hlstd{(nReg)}\hlopt{$}\hlstd{p.value} \hlopt{<} \hlnum{.05} \hlopt{%>%}
    \hlkwd{return}\hlstd{()}
\hlstd{\}}
\end{alltt}
...
\begin{alltt}
\hlcom{#plot some results}
\hlstd{plot9} \hlkwb{<-} \hlkwd{ggplot}\hlstd{(}\hlkwc{data} \hlstd{= pwr9,} \hlkwd{aes}\hlstd{(sampleSize, Power))} \hlopt{+}
          \hlkwd{geom_smooth}\hlstd{(}\hlkwc{fill} \hlstd{=} \hlnum{NA}\hlstd{)} \hlopt{+} \hlkwd{geom_point}\hlstd{()} \hlopt{+} \hlkwd{geom_hline}\hlstd{(}\hlkwc{yintercept}\hlstd{=}\hlnum{.8}\hlstd{)} \hlopt{+}
          \hlstd{myGGTheme} \hlopt{+}
          \hlkwd{ggtitle}\hlstd{(}\hlstr{"No Clustering - Levels"}\hlstd{)} \hlopt{+}
          \hlkwd{xlab}\hlstd{(}\hlstr{"Sample Size"}\hlstd{)} \hlopt{+}
          \hlkwd{scale_x_continuous}\hlstd{(}\hlkwc{breaks} \hlstd{=} \hlkwd{seq}\hlstd{(}\hlnum{0}\hlstd{,}\hlkwd{range}\hlstd{(pwr9}\hlopt{$}\hlstd{sampleSize)[}\hlnum{2}\hlstd{],}\hlnum{100}\hlstd{))} \hlopt{+}
          \hlkwd{ylab}\hlstd{(}\hlstr{"Power"}\hlstd{)} \hlopt{+}
          \hlkwd{scale_y_continuous}\hlstd{(}\hlkwc{breaks} \hlstd{=} \hlkwd{seq}\hlstd{(}\hlnum{0}\hlstd{,}\hlnum{1}\hlstd{,}\hlnum{.1}\hlstd{))}

\hlstd{plot10} \hlkwb{<-} \hlkwd{ggplot}\hlstd{(}\hlkwc{data} \hlstd{= pwr10,} \hlkwd{aes}\hlstd{(sampleSize, Power))} \hlopt{+}
          \hlkwd{geom_smooth}\hlstd{(}\hlkwc{fill} \hlstd{=} \hlnum{NA}\hlstd{)} \hlopt{+} \hlkwd{geom_point}\hlstd{()} \hlopt{+} \hlkwd{geom_hline}\hlstd{(}\hlkwc{yintercept}\hlstd{=}\hlnum{.8}\hlstd{)} \hlopt{+}
          \hlstd{myGGTheme} \hlopt{+}
          \hlkwd{ggtitle}\hlstd{(}\hlstr{"Casa Clustering - Levels"}\hlstd{)} \hlopt{+}
          \hlkwd{xlab}\hlstd{(}\hlstr{"Sample Size"}\hlstd{)} \hlopt{+}
          \hlkwd{scale_x_continuous}\hlstd{(}\hlkwc{breaks} \hlstd{=} \hlkwd{seq}\hlstd{(}\hlnum{0}\hlstd{,}\hlkwd{range}\hlstd{(pwr10}\hlopt{$}\hlstd{sampleSize)[}\hlnum{2}\hlstd{],}\hlnum{100}\hlstd{))} \hlopt{+}
          \hlkwd{ylab}\hlstd{(}\hlstr{"Power"}\hlstd{)} \hlopt{+}
          \hlkwd{scale_y_continuous}\hlstd{(}\hlkwc{breaks} \hlstd{=} \hlkwd{seq}\hlstd{(}\hlnum{0}\hlstd{,}\hlnum{1}\hlstd{,}\hlnum{.1}\hlstd{))}

\hlstd{plot11} \hlkwb{<-} \hlkwd{ggplot}\hlstd{(}\hlkwc{data} \hlstd{= pwr11,} \hlkwd{aes}\hlstd{(sampleSize, Power))} \hlopt{+}
          \hlkwd{geom_smooth}\hlstd{(}\hlkwc{fill} \hlstd{=} \hlnum{NA}\hlstd{)} \hlopt{+} \hlkwd{geom_point}\hlstd{()} \hlopt{+} \hlkwd{geom_hline}\hlstd{(}\hlkwc{yintercept}\hlstd{=}\hlnum{.8}\hlstd{)} \hlopt{+}
          \hlstd{myGGTheme} \hlopt{+}
          \hlkwd{ggtitle}\hlstd{(}\hlstr{"No Clustering - Logs"}\hlstd{)} \hlopt{+}
          \hlkwd{xlab}\hlstd{(}\hlstr{"Sample Size"}\hlstd{)} \hlopt{+}
          \hlkwd{scale_x_continuous}\hlstd{(}\hlkwc{breaks} \hlstd{=} \hlkwd{seq}\hlstd{(}\hlnum{0}\hlstd{,}\hlkwd{range}\hlstd{(pwr11}\hlopt{$}\hlstd{sampleSize)[}\hlnum{2}\hlstd{],}\hlnum{200}\hlstd{))} \hlopt{+}
          \hlkwd{ylab}\hlstd{(}\hlstr{"Power"}\hlstd{)} \hlopt{+}
          \hlkwd{scale_y_continuous}\hlstd{(}\hlkwc{breaks} \hlstd{=} \hlkwd{seq}\hlstd{(}\hlnum{0}\hlstd{,}\hlnum{1}\hlstd{,}\hlnum{.1}\hlstd{))}

\hlstd{plot12} \hlkwb{<-} \hlkwd{ggplot}\hlstd{(}\hlkwc{data} \hlstd{= pwr12,} \hlkwd{aes}\hlstd{(sampleSize, Power))} \hlopt{+}
          \hlkwd{geom_smooth}\hlstd{(}\hlkwc{fill} \hlstd{=} \hlnum{NA}\hlstd{)} \hlopt{+} \hlkwd{geom_point}\hlstd{()} \hlopt{+} \hlkwd{geom_hline}\hlstd{(}\hlkwc{yintercept}\hlstd{=}\hlnum{.8}\hlstd{)} \hlopt{+}
          \hlstd{myGGTheme} \hlopt{+}
          \hlkwd{ggtitle}\hlstd{(}\hlstr{"Casa Clustering - Logs"}\hlstd{)} \hlopt{+}
          \hlkwd{xlab}\hlstd{(}\hlstr{"Sample Size"}\hlstd{)} \hlopt{+}
          \hlkwd{scale_x_continuous}\hlstd{(}\hlkwc{breaks} \hlstd{=} \hlkwd{seq}\hlstd{(}\hlnum{0}\hlstd{,}\hlkwd{range}\hlstd{(pwr12}\hlopt{$}\hlstd{sampleSize)[}\hlnum{2}\hlstd{],}\hlnum{200}\hlstd{))} \hlopt{+}
          \hlkwd{ylab}\hlstd{(}\hlstr{"Power"}\hlstd{)} \hlopt{+}
          \hlkwd{scale_y_continuous}\hlstd{(}\hlkwc{breaks} \hlstd{=} \hlkwd{seq}\hlstd{(}\hlnum{0}\hlstd{,}\hlnum{1}\hlstd{,}\hlnum{.1}\hlstd{))}
...
\hlstd{nFinder2} \hlkwb{<-} \hlkwa{function}\hlstd{(}\hlkwc{N}\hlstd{,} \hlkwc{MDE}\hlstd{,} \hlkwc{cluster}\hlstd{,} \hlkwc{logs}\hlstd{,} \hlkwc{levels}\hlstd{)\{}
  ...
  \hlstd{bootSample} \hlkwb{<-} \hlkwd{sample_n}\hlstd{(controlHHs,} \hlkwc{size} \hlstd{= N,} \hlkwc{replace} \hlstd{=} \hlnum{TRUE}\hlstd{)} \hlopt{%>%}
    \hlkwd{mutate}\hlstd{(}\hlkwc{bootID} \hlstd{=} \hlkwd{row_number}\hlstd{(),}
           \hlkwc{inTreatment} \hlstd{=} \hlkwd{ifelse}\hlstd{(bootID} \hlopt{<=} \hlnum{100}\hlstd{,} \hlnum{1}\hlstd{,}\hlnum{0}\hlstd{))}
...
\begin{alltt}
\hlcom{#plot some results}
\hlstd{plot13} \hlkwb{<-} \hlkwd{ggplot}\hlstd{(}\hlkwc{data} \hlstd{= pwr13,} \hlkwd{aes}\hlstd{(sampleSize, Power))} \hlopt{+}
          \hlkwd{geom_smooth}\hlstd{(}\hlkwc{fill} \hlstd{=} \hlnum{NA}\hlstd{)} \hlopt{+} \hlkwd{geom_point}\hlstd{()} \hlopt{+} \hlkwd{geom_hline}\hlstd{(}\hlkwc{yintercept}\hlstd{=}\hlnum{.8}\hlstd{)} \hlopt{+}
          \hlstd{myGGTheme} \hlopt{+}
          \hlkwd{ggtitle}\hlstd{(}\hlstr{"No Clustering - Levels"}\hlstd{)} \hlopt{+}
          \hlkwd{xlab}\hlstd{(}\hlstr{"Sample Size"}\hlstd{)} \hlopt{+}
          \hlkwd{scale_x_continuous}\hlstd{(}\hlkwc{breaks} \hlstd{=} \hlkwd{seq}\hlstd{(}\hlnum{0}\hlstd{,}\hlkwd{range}\hlstd{(pwr13}\hlopt{$}\hlstd{sampleSize)[}\hlnum{2}\hlstd{],}\hlnum{100}\hlstd{))} \hlopt{+}
          \hlkwd{ylab}\hlstd{(}\hlstr{"Power"}\hlstd{)} \hlopt{+}
          \hlkwd{scale_y_continuous}\hlstd{(}\hlkwc{breaks} \hlstd{=} \hlkwd{seq}\hlstd{(}\hlnum{0}\hlstd{,}\hlnum{1}\hlstd{,}\hlnum{.1}\hlstd{))}

\hlstd{plot14} \hlkwb{<-} \hlkwd{ggplot}\hlstd{(}\hlkwc{data} \hlstd{= pwr14,} \hlkwd{aes}\hlstd{(sampleSize, Power))} \hlopt{+}
          \hlkwd{geom_smooth}\hlstd{(}\hlkwc{fill} \hlstd{=} \hlnum{NA}\hlstd{)} \hlopt{+} \hlkwd{geom_point}\hlstd{()} \hlopt{+} \hlkwd{geom_hline}\hlstd{(}\hlkwc{yintercept}\hlstd{=}\hlnum{.8}\hlstd{)} \hlopt{+}
          \hlstd{myGGTheme} \hlopt{+}
          \hlkwd{ggtitle}\hlstd{(}\hlstr{"Casa Clustering - Levels"}\hlstd{)} \hlopt{+}
          \hlkwd{xlab}\hlstd{(}\hlstr{"Sample Size"}\hlstd{)} \hlopt{+}
          \hlkwd{scale_x_continuous}\hlstd{(}\hlkwc{breaks} \hlstd{=} \hlkwd{seq}\hlstd{(}\hlnum{0}\hlstd{,}\hlkwd{range}\hlstd{(pwr14}\hlopt{$}\hlstd{sampleSize)[}\hlnum{2}\hlstd{],}\hlnum{100}\hlstd{))} \hlopt{+}
          \hlkwd{ylab}\hlstd{(}\hlstr{"Power"}\hlstd{)} \hlopt{+}
          \hlkwd{scale_y_continuous}\hlstd{(}\hlkwc{breaks} \hlstd{=} \hlkwd{seq}\hlstd{(}\hlnum{0}\hlstd{,}\hlnum{1}\hlstd{,}\hlnum{.1}\hlstd{))}

\hlstd{plot15} \hlkwb{<-} \hlkwd{ggplot}\hlstd{(}\hlkwc{data} \hlstd{= pwr15,} \hlkwd{aes}\hlstd{(sampleSize, Power))} \hlopt{+}
          \hlkwd{geom_smooth}\hlstd{(}\hlkwc{fill} \hlstd{=} \hlnum{NA}\hlstd{)} \hlopt{+} \hlkwd{geom_point}\hlstd{()} \hlopt{+} \hlkwd{geom_hline}\hlstd{(}\hlkwc{yintercept}\hlstd{=}\hlnum{.8}\hlstd{)} \hlopt{+}
          \hlstd{myGGTheme} \hlopt{+}
          \hlkwd{ggtitle}\hlstd{(}\hlstr{"No Clustering - Logs"}\hlstd{)} \hlopt{+}
          \hlkwd{xlab}\hlstd{(}\hlstr{"Sample Size"}\hlstd{)} \hlopt{+}
          \hlkwd{scale_x_continuous}\hlstd{(}\hlkwc{breaks} \hlstd{=} \hlkwd{seq}\hlstd{(}\hlnum{0}\hlstd{,}\hlkwd{range}\hlstd{(pwr15}\hlopt{$}\hlstd{sampleSize)[}\hlnum{2}\hlstd{],}\hlnum{200}\hlstd{))} \hlopt{+}
          \hlkwd{ylab}\hlstd{(}\hlstr{"Power"}\hlstd{)} \hlopt{+}
          \hlkwd{scale_y_continuous}\hlstd{(}\hlkwc{breaks} \hlstd{=} \hlkwd{seq}\hlstd{(}\hlnum{0}\hlstd{,}\hlnum{1}\hlstd{,}\hlnum{.1}\hlstd{))}

\hlstd{plot16} \hlkwb{<-} \hlkwd{ggplot}\hlstd{(}\hlkwc{data} \hlstd{= pwr16,} \hlkwd{aes}\hlstd{(sampleSize, Power))} \hlopt{+}
          \hlkwd{geom_smooth}\hlstd{(}\hlkwc{fill} \hlstd{=} \hlnum{NA}\hlstd{)} \hlopt{+} \hlkwd{geom_point}\hlstd{()} \hlopt{+} \hlkwd{geom_hline}\hlstd{(}\hlkwc{yintercept}\hlstd{=}\hlnum{.8}\hlstd{)} \hlopt{+}
          \hlstd{myGGTheme} \hlopt{+}
          \hlkwd{ggtitle}\hlstd{(}\hlstr{"Casa Clustering - Logs"}\hlstd{)} \hlopt{+}
          \hlkwd{xlab}\hlstd{(}\hlstr{"Sample Size"}\hlstd{)} \hlopt{+}
          \hlkwd{scale_x_continuous}\hlstd{(}\hlkwc{breaks} \hlstd{=} \hlkwd{seq}\hlstd{(}\hlnum{0}\hlstd{,}\hlkwd{range}\hlstd{(pwr16}\hlopt{$}\hlstd{sampleSize)[}\hlnum{2}\hlstd{],}\hlnum{200}\hlstd{))} \hlopt{+}
          \hlkwd{ylab}\hlstd{(}\hlstr{"Power"}\hlstd{)} \hlopt{+}
          \hlkwd{scale_y_continuous}\hlstd{(}\hlkwc{breaks} \hlstd{=} \hlkwd{seq}\hlstd{(}\hlnum{0}\hlstd{,}\hlnum{1}\hlstd{,}\hlnum{.1}\hlstd{))}
...
{\ttfamily\noindent\color{warningcolor}{\#\# Warning in simpleLoess(y, x, w, span, degree = degree, parametric = parametric, : Chernobyl! trL>n 6}}

{\ttfamily\noindent\color{warningcolor}{\#\# Warning in simpleLoess(y, x, w, span, degree = degree, parametric = parametric, : Chernobyl! trL>n 6}}

{\ttfamily\noindent\color{warningcolor}{\#\# Warning in sqrt(sum.squares/one.delta): NaNs produced}}

{\ttfamily\noindent\color{warningcolor}{\#\# Warning in stats::qt(level/2 + 0.5, pred\$df): NaNs produced}}\end{kframe}
